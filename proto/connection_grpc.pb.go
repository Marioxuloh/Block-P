...
const (
	ConnectionService_RequestConnection_FullMethodName = "/proto.connection.ConnectionService/RequestConnection"
)
...
type ConnectionServiceClient interface {
	RequestConnection(ctx context.Context, in *ConnectionRequest, opts ...grpc.CallOption) (*Acknowledge, error)
}
...
func (c *connectionServiceClient) RequestConnection(ctx context.Context, in *ConnectionRequest, opts ...grpc.CallOption) (*Acknowledge, error) {
	out := new(Acknowledge)
	err := c.cc.Invoke(ctx, ConnectionService_RequestConnection_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConnectionServiceServer interface {
	RequestConnection(context.Context, *ConnectionRequest) (*Acknowledge, error)
...
func (UnimplementedConnectionServiceServer) RequestConnection(context.Context, *ConnectionRequest) (*Acknowledge, error) {
...
func _ConnectionService_RequestConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConnectionServiceServer).RequestConnection(ctx, req.(*ConnectionRequest))
	}
...
var ConnectionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.connection.ConnectionService",
